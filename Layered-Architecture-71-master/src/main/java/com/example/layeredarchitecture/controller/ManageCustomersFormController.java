...
public class ManageCustomersFormController {
    ...
    public void initialize() {
        ...
        //TABLE DATA LOAD TO THE ALL DATA
    ...
    private void loadAllCustomers(){
        tblCustomers.getItems().clear(); // Clear existing items

        /* Get all customers */
        try {
            ArrayList<CustomerDTO> customerDTOS = customerDaoImpl.getAllcustDetails();
            ObservableList<CustomerTM> customerTMS = FXCollections.observableArrayList();

            for (CustomerDTO dto : customerDTOS) {
                CustomerTM customerTM = new CustomerTM(dto.getId(), dto.getName(), dto.getAddress());
                customerTMS.add(customerTM);
            }

            tblCustomers.setItems(customerTMS); // Set new items
